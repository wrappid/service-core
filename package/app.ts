...
import { setupRegistry } from "./registry/setup.registry";


export  class App {
  constructor(wrappidApp: any,ControllersRegistry: any, FunctionsRegistry: any, ModelsRegistry: any, RoutesRegistry: any, TasksRegistry: any,ValidationsRegistry:any, swaggerJsonFile: any){
    const options = {
      inflate: true,
      limit: "50mb",
     ...
     */
    setupRegistry(ControllersRegistry, FunctionsRegistry, ModelsRegistry, RoutesRegistry, TasksRegistry, MiddlewaresRegistry, ValidationsRegistry)
  }
}